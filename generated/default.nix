...
in {
  dev = {
    "@vue/test-utils" = nodePackages."@vue/test-utils-^1.0.0-beta.13";
    ...
    chromedriver = nodePackages."chromedriver-^2.37.0";
    ...
    mocha = nodePackages."mocha-^5.0.5";
    ...
    "webpack-hot-middleware" = nodePackages."webpack-hot-middleware-^2.22.0";
  };
  ...
  main = {
    ...
    autoprefixer = nodePackages."autoprefixer-^8.2.0";
    ...
    "bootstrap-vue" = nodePackages."bootstrap-vue-^2.0.0-rc.6";
    ...
    "express-validator" = nodePackages."express-validator-^5.1.2";
    ...
    moment = nodePackages."moment-^2.22.0";
    "moment-recur" = nodePackages."moment-recur-^1.0.7";
    mongoose = nodePackages."mongoose-^5.0.14";
    morgan = nodePackages."morgan-^1.7.0";
    nconf = nodePackages."nconf-^0.10.0";
    "node-sass" = nodePackages."node-sass-^4.8.3";
