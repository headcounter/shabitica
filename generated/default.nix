...
in {
  dev = {
    "@vue/test-utils" = nodePackages."@vue/test-utils-^1.0.0-beta.25";
    ...
    chromedriver = nodePackages."chromedriver-^2.41.0";
    "connect-history-api-fallback" = nodePackages."connect-history-api-fallback-^1.1.0";
    coveralls = nodePackages."coveralls-^3.0.2";
    ...
    "eslint-loader" = nodePackages."eslint-loader-^2.1.0";
    "eslint-plugin-html" = nodePackages."eslint-plugin-html-^4.0.5";
    "eslint-plugin-mocha" = nodePackages."eslint-plugin-mocha-^5.2.0";
    ...
    "karma-webpack" = nodePackages."karma-webpack-^3.0.5";
    ...
    puppeteer = nodePackages."puppeteer-^1.8.0";
    "require-again" = nodePackages."require-again-^2.0.0";
    "selenium-server" = nodePackages."selenium-server-^3.14.0";
    sinon = nodePackages."sinon-^4.5.0";
    "sinon-chai" = nodePackages."sinon-chai-^3.2.0";
    ...
    "webpack-hot-middleware" = nodePackages."webpack-hot-middleware-^2.24.0";
  };
  ...
  main = {
    ...
    autoprefixer = nodePackages."autoprefixer-^8.6.5";
    ...
    "babel-eslint" = nodePackages."babel-eslint-^8.2.6";
    "babel-loader" = nodePackages."babel-loader-^7.1.5";
    ...
    bootstrap = nodePackages."bootstrap-^4.1.3";
    "bootstrap-vue" = nodePackages."bootstrap-vue-^2.0.0-rc.9";
    compression = nodePackages."compression-^1.7.3";
    ...
    "express-validator" = nodePackages."express-validator-^5.3.0";
    "extract-text-webpack-plugin" = nodePackages."extract-text-webpack-plugin-^3.0.2";
    glob = nodePackages."glob-^7.1.3";
    got = nodePackages."got-^9.2.2";
    ...
    mongoose = nodePackages."mongoose-^5.2.15";
    morgan = nodePackages."morgan-^1.9.1";
    nconf = nodePackages."nconf-^0.10.0";
    "node-sass" = nodePackages."node-sass-^4.9.3";
    ora = nodePackages."ora-^2.1.0";
    pageres = nodePackages."pageres-^4.1.1";
    passport = nodePackages."passport-^0.4.0";
    "popper.js" = nodePackages."popper.js-^1.14.4";
    ...
    "sass-loader" = nodePackages."sass-loader-^7.1.0";
    ...
    svgo = nodePackages."svgo-^1.1.1";
    "svgo-loader" = nodePackages."svgo-loader-^2.2.0";
    "systemd-socket" = nodePackages."systemd-socket-^0.0.0";
    update = nodePackages."update-^0.7.4";
    upgrade = nodePackages."upgrade-^1.1.0";
    "url-loader" = nodePackages."url-loader-^1.1.1";
    useragent = nodePackages."useragent-^2.1.9";
    uuid = nodePackages."uuid-^3.3.2";
    validator = nodePackages."validator-^10.7.1";
    "vinyl-buffer" = nodePackages."vinyl-buffer-^1.0.1";
    vue = nodePackages."vue-^2.5.17";
    ...
    "vue-style-loader" = nodePackages."vue-style-loader-^4.1.2";
    "vue-template-compiler" = nodePackages."vue-template-compiler-^2.5.17";
    ...
    "webpack-merge" = nodePackages."webpack-merge-^4.1.4";
    winston = nodePackages."winston-^2.4.4";
